...
>
  <a class="relative mx-3 mt-3 flex h-60 overflow-hidden rounded-xl" href="/a">
    <!-- svelte-ignore a11y-img-redundant-alt -->
    <img class="object-cover" src={bookCover} alt="product image" />
  ...
  <div class="mt-4 px-5 pb-5">
    ...
    <div class="mt-2 flex items-center justify-between">
      <p>
        <span class="text-xl font-bold text-slate-900">IDR 145.000</span>
      </p>
    </div>
    <div class="-mt-8 flex items-center justify-between">
      <p>
        <span class="text-sm text-slate-900 line-through">IDR 200.000</span>
      </p>
    </div>
